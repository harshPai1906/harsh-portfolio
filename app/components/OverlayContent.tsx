...
export default function OverlayContent() {
  ...
  const projects: ProjectData[] = [
    ...
    {
      title: "TravelAI – AI Travel Planning System",
      ...
      longDescription: "Built an AI travel planner generating personalized itineraries for 1–12 days across any destination. Developed a 4-agent architecture for Flights, Hotels, Places, and Itinerary recommendations. Engineered the system using Python, LangGraph, and PostgreSQL, reducing manual planning time by 70%.",
      ...
      metrics: [
        { label: "Planning Time", value: "-70%" },
        { label: "AI Agents", value: "4 Autonomous" },
        { label: "Itinerary Span", value: "1–12 Days" },
      ],
      features: [
        "Personalized itineraries for 1–12 days across any destination",
        "4-agent architecture for Flights, Hotels, Places, and Itinerary recommendations",
